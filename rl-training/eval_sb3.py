...
if __name__ == '__main__':
    ...
    saver_restore = os.path.join(cwd, 'saver_data/TQC_Flaps_Model_FreeMoving_96480_steps.zip')
    vecnorm_path = os.path.join(cwd, 'saver_data/TQC_Flaps_Model_FreeMoving_vecnormalize_96480_steps.pkl')
    example_environment = SubprocVecEnv([create_env(env_config, 10000, i) for i in range(1)], start_method='spawn')
